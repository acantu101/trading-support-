...
def teardown():
    ...
    stray_names = ["oms_client", "mdf_feed_handler", "risk_engine", "fix_engine", "oms_server"]
    for proc_name in stray_names:
...
"""
    ...
    print(f"""
{BOLD}{SEPARATOR}{RESET}
{GREEN}{BOLD}  Lab is live. Work through the tasks above.{RESET}

  While the lab is running:
{CYAN}    sudo python3 lab_setup.py --status       {RESET}see running processes
{CYAN}    sudo python3 lab_setup.py --teardown     {RESET}clean everything up
{BOLD}{SEPARATOR}{RESET}
""")
